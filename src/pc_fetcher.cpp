...
pc_fetcher::pc_fetcher(){
    ...
    _kFMsgStampedPub = _nh.advertise<slave_robot1::keyframeMsgStamped>("/slave_robot1/kFMsgStamped", 5);
    _kFGraphMsgStampedPub = _nh.advertise<slave_robot1::keyframeGraphMsgStamped>("/slave_robot1/kFGraphMsgStamped", 5);
}
...
void pc_fetcher::pcCallback(slave_robot1::keyframeMsgConstPtr msg){
...
void pc_fetcher::kfCallback(slave_robot1::keyframeGraphMsgConstPtr graph_msg) {
	kfIndex=(uint32_t)graph_msg->numFrames;

    this->copykFGraphMsgTokFGraphMsgStamped(graph_msg);
}

void pc_fetcher::readkFMsg(slave_robot1::keyframeMsgConstPtr msg) {
...
void pc_fetcher::copykFMsgTokFMsgStamped(slave_robot1::keyframeMsgConstPtr msg) {
	ros::Time timeStampTmp(msg->time);
...
void pc_fetcher::copykFGraphMsgTokFGraphMsgStamped(slave_robot1::keyframeGraphMsgConstPtr graph_msg) {
