...
class pc_fetcher{
    public:
		...
		pc_fetcher();
		~pc_fetcher();
		void pcCallback(slave_robot1::keyframeMsgConstPtr msg);
		void kfCallback(slave_robot1::keyframeGraphMsgConstPtr graph_msg);
    ...
    private:
		...
		slave_robot1::keyframeMsgStamped _kFMsgStamped;
		slave_robot1::keyframeGraphMsgStamped _kFGraphMsgStamped;
		 ...
		 */
		void readkFMsg(slave_robot1::keyframeMsgConstPtr msg);
		 ...
		 */
		void copykFMsgTokFMsgStamped(slave_robot1::keyframeMsgConstPtr msg);
		 ...
		 */
		void copykFGraphMsgTokFGraphMsgStamped(slave_robot1::keyframeGraphMsgConstPtr msg);
